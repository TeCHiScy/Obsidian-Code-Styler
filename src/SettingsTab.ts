...
export class SettingsTab extends PluginSettingTab {
	...
	generateDonationFooter(containerEl: HTMLElement) {
		...
		const donationDiv = containerEl.createEl("div", {
			cls: "code-styler-donation",
		});
		const donationText = createEl("p", {
			text: "If you like this plugin, and would like to help support continued development, use the button below!",
		});
		donationDiv.appendChild(donationText);
		const donationButton = createEl("a", {
			href: "https://www.buymeacoffee.com/mayurankv",
		});
		donationButton.innerHTML =
			'<img src="https://img.buymeacoffee.com/button-api/?text=Buy me a coffee&emoji=&slug=mayurankv&button_colour=e3e7efa0&font_colour=262626&font_family=Inter&outline_colour=262626&coffee_colour=a0522d" height="42px">';
