...
export const EXT_REF_CACHE = EXT_REF_PATH + "cache.json";
...
export function extRefContentPath(id: string): string {
	return EXT_REF_PATH + id;
}

export function extRefMetadataPath(id: string): string {
	return EXT_REF_PATH + id + EXT_REF_METADATA_SUFFIX;
}
